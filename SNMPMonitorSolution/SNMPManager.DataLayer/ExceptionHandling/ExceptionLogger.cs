...
namespace SNMPManager.DataLayer.ExceptionHandling
{
    public class ExceptionLogger
    {
        ...
        {
            DatabaseConnectionManager connectionManager = new DatabaseConnectionManager(Properties.Settings.Default.ProdDatabase);
            connectionManager.AddEventToDatabase(exc.GetType().ToString(), category, DateTime.Now, exc.HResult, exc.Message, exc.StackTrace);
        }
    }
}
